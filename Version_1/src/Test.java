public class Test
{
    public static void main(String[] args)
    {
        ...
        Guardsmen guardsmen = new Guardsmen();
        TreasureRoomMonitor<Valuable> treasureRoomMonitor = new TreasureRoomMonitor<>(guardsmen);
        ...
        ValuableTransporter valuableTransporter = new ValuableTransporter(deposit, guardsmen);
